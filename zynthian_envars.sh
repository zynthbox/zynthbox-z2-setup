...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_14__UI_BOLD="LEARN"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_14__UI_SHORT="LEARN"
...
export ZYNTHIAN_WIRING_LAYOUT_CUSTOM_PROFILE="z2_v1"
...
export ZYNTHIAN_WIRING_CUSTOM_SWITCH_09__UI_BOLD="ZYNPAD"
